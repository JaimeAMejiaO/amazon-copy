            ...
            <tbody>
                @foreach ($pedidos as $pedido)
                    <tr>
                        ...
                        @endif
                        <td>
                            <a href="#" class="btn btn-success btn-sm"><i class="fa-solid fa-money-bill fa-2xl"></i></a>
                            <a href="#" class="btn btn-warning btn-sm"><i class="fa-solid fa-truck-fast fa-2xl"></i></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
