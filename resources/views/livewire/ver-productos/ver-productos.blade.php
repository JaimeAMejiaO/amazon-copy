    ...
    <div style=" " class="d-flex">
        ...
        <div class="col-3" style="margin-top:2%;">
            ...
            <h2 class="a-size-mini a-spacing-none a-color-base s-line-clamp-4"
                style="font-size: 200%;font-weight:bold;margin-left: 5%;"> {{ $id_producto_modelo->producto->marca->nombre }}
            </h2>
            ...
            <h3 class="a-size-mini a-spacing-none a-color-base s-line-clamp-4"
                style="font-size: 200%;font-weight:bold;margin-left: 20px;margin-top:2%">$ {{ $id_producto_modelo->precio }}
            </h3>
            <h3 class="a-size-mini a-spacing-none a-color-base s-line-clamp-4"
