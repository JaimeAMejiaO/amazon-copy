<div style="background-color:#">
    <div style=" " class="d-flex">
            ...
            <div class="d-flex" style="margin-top:5%;">
                ...
                <div class="col-3" style="margin-left:2%;">
                    ...
                    <h3 class="a-size-mini a-spacing-none a-color-base s-line-clamp-4"
                        ...
                        {{ $modelo_actual->precio }}
                    </h3>
                    <h3 class="a-size-mini a-spacing-none a-color-base s-line-clamp-4"
                        style="font-size: 150%;font-weight:bold;margin-left: 5%;">
                        Categoria: {{ $modelo_actual->producto->categoria->nombre }} </h3>

                    @foreach ($producto_modelos as $producto_modelo)
                        <h3 class="a-size-mini a-spacing-none a-color-base s-line-clamp-4"
                            style="font-size: 150%;font-weight:bold;margin-left: 5%;">Tipo:
                            {{ $producto_modelo->nombre }}</h3>
                    @endforeach

                    <h2 class="a-size-mini a-spacing-none a-color-base s-line-clamp-4"
                        style="font-size: 150%;font-weight:bold;margin-left: 5%;">Marca:
                        {{ $modelo_actual->producto->marca->nombre }}
                    </h2>
                    ...
                    @foreach ($explode_array_cat as $titulo_caracteristica => $valor_caracteristica)
                        <h3 class="a-size-mini a-spacing-none a-color-base s-line-clamp-4"
                            style="font-size: 120%;font-weight:bold;margin-left: 10%;">
                            -{{ $titulo_caracteristica }}:</b>
                            {{ $valor_caracteristica }}</h3>
                    @endforeach
        ...
        -->
                ...
                <div class="col-2 " style="margin-top:1%;margin-left:%;">

                    <h3 class="a-size-mini a-spacing-none a-color-base s-line-clamp-4"
                        style="font-size: 150%;font-weight:bold;text-align:center">Descripcion</h3>
        ...
        <div class="card mb-3 card "
            style="width: 18rem; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);margin-top:2%;margin-right:10%">
            <div class="card-body">
                ...
                <div class="">
                    <div class=""style="margin-top: 5px;">
                        <h3 class="">Stock: {{ $modelo_actual->stock }} </h3>
                    </div>
                    <div class="d-flex align-items-center" style="margin-top: 10%;">
                        <h3 class="me-3">Cantidad:</h3>
                        <select class="form-select form-select-sm" style="width: 70px;"
                            wire:model="cant_seleccionada" name="cant_seleccionada" id="cant_seleccionada">
                ...
                <div style="text-align:center">
                    ...
                    <br>
                    <div>
                        <button class="btn btn-dark text-nowrap" wire:click="send_to_cart" data-bs-toggle="modal"
                            data-bs-target="#modal_producto">AGREGAR AL CARRO</button>
                    </div>
                    <br>
                    <div>
                        <a class="btn btn-dark text-nowrap" href="{{ route('carro-compras') }}">Ver Carro</a>
                    </div>
